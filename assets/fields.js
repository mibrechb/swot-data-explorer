...
export const VARIABLE_META = {
  ...
  dschg_c: ['L2 near-real-time discharge', 'm³/s'],
  sos_consensus_q: ['SoS consensus discharge', 'm³/s'],
  sos_hivdi_q: ['SoS discharge — HiVDI', 'm³/s'],
  sos_metroman_q: ['SoS discharge — MetroMan', 'm³/s'],
  sos_momma_q: ['SoS discharge — MOMMA', 'm³/s'],
  sos_sad_q: ['SoS discharge — SAD', 'm³/s'],
  sos_sic4dvar_q: ['SoS discharge — SIC4DVar', 'm³/s'],
  sos_lakeflow_q: ['SoS discharge — LakeFlow', 'm³/s'],
